...
:::caution
An LTE antenna must be connected to the LTE SMA port on the display before testing. 
Without an antenna, the module will not receive a strong signal and can lead to connectivity issues.
:::
