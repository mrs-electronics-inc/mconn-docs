...
:::note
The RTC operates in **UTC**. When setting the time with `date -s`, always specify the time in UTC regardless of your local timezone.
:::

To set up the RTC, enter the following commands in the terminal:

```shell
date -s "2021-07-22 17:00:00 UTC"
hwclock -w 
```
