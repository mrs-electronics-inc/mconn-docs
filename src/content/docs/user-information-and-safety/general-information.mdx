...
The display is available in three standard screen sizes: _7", 10.1", and 12.3"_. Depending on the project volume, customization in other sizes is also possible.
...
Portions of this documentation are based on materials originally developed by MRS Electronic GmbH & Co. KG and are used with written permission. Adaptations and modifications have been made for this product and market by MRS Electronic, Inc.
